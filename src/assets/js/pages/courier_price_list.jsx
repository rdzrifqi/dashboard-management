...
const CourierTable = () => {
    ...
    const columns = [
        { label: "Customer Name", index: 1, default: true },
        { label: "DC Code", index: 2, default: true },
        { label: "Address", index: 3, default: true },
        { label: "Kode Pos", index: 4, default: true },
        { label: "Pulau", index: 5, default: true },
        { label: "Propinsi", index: 6, default: true },
        { label: "Kabupaten", index: 7, default: true },
        { label: "Kecamatan", index: 8, default: false },
        { label: "Kelurahan", index: 9, default: false },
        { label: "Freight Type", index: 10, default: false },
        { label: "Vendor", index: 11, default: false },
        { label: "Service", index: 12, default: false },
        { label: "City Code", index: 13, default: false },
        { label: "Prev Effective Code", index: 14, default: false },
        { label: "Prev Leadtime", index: 15, default: false },
        { label: "Prev Min Kgs", index: 16, default: false },
        { label: "Prev Price", index: 17, default: false },
        { label: "Latest Effective Code", index: 18, default: false },
        { label: "Latest Leadtime", index: 19, default: false },
        { label: "Latest Min Kgs", index: 20, default: false },
        { label: "Latest Price", index: 21, default: false },
        { label: "Diff Price", index: 22, default: false },
        { label: "Latest Doc Leadtime", index: 23, default: false },
        { label: "Latest Doc Price", index: 24, default: false },
        { label: "Lowest Min Kgs", index: 25, default: false },
        { label: "Lowest Price", index: 26, default: false },
        { label: "Base Vendor", index: 27, default: false },
    ];
