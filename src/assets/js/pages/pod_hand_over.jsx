...
const PodHandOverTable = () => {
    const tableRef = useRef();
    const [podHandOverData, setPodHandOverData] = useState([]);
    ...
    const columns = [
        { label: "Do Sent", index: 1, default:true },
        { label: "Do Received", index: 2, default:true },
        { label: "Cancel Status", index: 3, default:true },
        { label: "Cust PO No", index: 4, default:true },
        { label: "AWB No", index: 5, default:true },
        { label: "Cust PO Date", index: 6, default:true },
        { label: "Customer Name", index: 7, default:false },
        { label: "DC Name", index: 8, default:false },
        { label: "DO No", index: 9, default:false },
        { label: "DO Date", index: 10, default:false },
        { label: "Shipped By", index: 11, default:false },
        { label: "Qty Shipped", index: 12, default:false },
        { label: "Qty Shipped Box", index: 13, default:false },
        { label: "Do Sent By", index: 14, default:false },
        { label: "Do Sent At", index: 15, default:false },
        { label: "Do Received By", index: 16, default:false },
        { label: "Do Received At", index: 17, default:false },
    ];
    ...
    const fetchData = (page = 1) => {
        ...
        axios.get(`${__ODOO_URL__}/api/odoo/pod-hand-over?search=${searchText}&limit=${limit}&offset=${offset}`)
            .then(res => {
                ...
                setPodHandOverData(result.data.data || []);
