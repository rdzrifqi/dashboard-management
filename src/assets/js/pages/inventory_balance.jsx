...
const InventoryBalanceTable = () => {
    ...
    const columns = [
        { label: "Brand", index: 1, default:true },
        { label: "Product Code", index: 2, default:true },
        { label: "Product Name", index: 3, default:true },
        { label: "Location", index: 4, default:true },
        { label: "Std Pack", index: 5, default:true },
        { label: "Balance Qty", index: 6, default:true }
    ];
    ...
    const fetchData = (page = 1) => {
        ...
        axios.get(`${__ODOO_URL__}/api/odoo/inventory-balance?search=${searchText}&limit=${limit}&offset=${offset}`)
            .then(res => {
                ...
                setInventoryBalanceData(result.data.data || []);
...
root.render(<InventoryBalanceTable />);